...
import ru.shtrm.gosport.db.adapters.UserSportListAdapter;
...
public class TrainingInfoFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        ArrayList<UserSport> userSport =  UserSport.getUserSportsByTraining(realmDB, training);
        final UserSportListAdapter userSportAdapter =
                new UserSportListAdapter(mainActivityConnector, R.layout.user_item_list_layout, userSport);
        ListView playerListView = view.findViewById(R.id.players_listView);
        playerListView.setAdapter(userSportAdapter);
        MainFunctions.setListViewHeightBasedOnChildren(playerListView);
    }
